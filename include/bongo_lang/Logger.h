...
namespace BongoJam {
        ...
        )
    {
        ...
        std::transform(f_NormalizedColour.begin(), f_NormalizedColour.end(), f_NormalizedColour.begin(), ::tolower);

        //////////////////// Regular Colours ////////////////////

        if(f_NormalizedColour == "black") 
        {
            return "\x1B[30m" + fp_SampleText + "\033[0m";
        }
        else if(f_NormalizedColour == "red")
        {
            return "\x1B[31m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "green")
        {
            return "\x1B[32m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "yellow")
        {
            return "\x1B[33m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "blue")
        {
            return "\x1B[34m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "magenta")
        {
            return "\x1B[35m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "cyan")
        {
            return "\x1B[36m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "white")
        {
        ...
        if (f_NormalizedColour == "bright black")
        {
            return "\x1B[90m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "bright red")
        {
            return "\x1B[91m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "bright green")
        {
            return "\x1B[92m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "bright yellow")
        {
            return "\x1B[93m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "bright blue")
        {
            return "\x1B[94m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "bright magenta")
        {
            return "\x1B[95m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "bright cyan")
        {
            return "\x1B[96m" + fp_SampleText + "\033[0m";
        }
        else if (f_NormalizedColour == "bright white")
        {
